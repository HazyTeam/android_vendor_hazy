...
ifneq ($(filter hazy_i9300 hazy_mako hazy_maguro hazy_p3100 hazy_manta full_toroplus full_grouper full_tilapia,$(TARGET_PRODUCT)),)
    PRODUCT_COPY_FILES += \
        vendor/hazy/prebuilt/bootanimation/1280x720.zip:system/media/bootanimation.zip
endif
ifneq ($(filter hazy_hammerhead hazy_bacon hazy_falcon,$(TARGET_PRODUCT)),)
    PRODUCT_COPY_FILES += \
...
PRODUCT_COPY_FILES += \
    ...
    vendor/hazy/proprietary/system/app/Superuser.apk:system/app/Superuser.apk \
    vendor/hazy/proprietary/system/bin/su.apk:system/bin/su
